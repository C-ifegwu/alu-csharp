...
{
    /// <summary>
    /// Represents a Zombie enemy with health, a name, and a custom string representation.
    /// </summary>
    public class Zombie
    {
        ...
        /// <summary>
        /// Returns a string that represents the current zombie's name and health.
        /// </summary>
        /// <returns>A formatted string: "Zombie Name: {name} / Total Health: {health}"</returns>
